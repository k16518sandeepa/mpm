const subtitles = [
      ...
      },
      {
        ...
        img: "https://pinnedupink.com/cdn/shop/articles/86-eighty-six-anime-review-581891.jpg?v=1746517718",
        hasVideoDownload: true, 
        videoDownloadLink: "https://motionpicturemafia.com/downloads"
      },
	{
        id: "Akame_Ga_kill",
        title: "Akame ga Kill!",
        plot: "A countryside boy named Tatsumi sets out on a journey to The Capital to make a name for himself and met a seemingly dangerous group of Assassins known as Night Raid. Their journey begins.",
        img: "https://m.media-amazon.com/images/S/pv-target-images/d687ee39230272f5fbf4d1f1563a5f7661fcc243ac3b116c29880b0dbd4a20e6.jpg",
        hasVideoDownload: true, 
        videoDownloadLink: "https://motionpicturemafia.com/downloads"
      },
	{
        ...
        img: "https://animehunch.com/wp-content/uploads/2025/06/the-summer-hikaru-died.jpg",
        hasVideoDownload: true, 
        videoDownloadLink: "https://motionpicturemafia.com/downloads"
      },
	{
        id: "Dororo",
        title: "Dororo",
        plot: "Sightless Hyakkimaru wields fearsome prosthetics in place of the limbs his father traded to 12 demons. When he encounters the young thief Dororo, the pair sets out to reclaim Hyakkimaru's body parts and survive the demon-infested world.",
        img: "https://preview.redd.it/dororo-is-peak-fiction-v0-il67pnv5oube1.jpeg?auto=webp&s=972822fa13ca5c056f2862aa810def6f82e4d426",
        hasVideoDownload: true, 
        videoDownloadLink: "https://motionpicturemafia.com/downloads"
      },
	{
        id: "The_Witch_and_the_beast",
        title: "The Witch and the Beast",
        plot: "A cursed girl and a mysterious man join forces to hunt down an evil witch.",
        img: "https://imgsrv.crunchyroll.com/cdn-cgi/image/fit=contain,format=auto,quality=85,width=1200,height=675/catalog/crunchyroll/0207a74ac6b7a6359edce4463c077cf3.jpg",
        hasVideoDownload: true, 
        videoDownloadLink: "https://motionpicturemafia.com/downloads"
      },
	{
        id: "Shadow_House",
        title: "Shadows House",
        plot: "In a grandiose mansion, a young cheerful living doll begins to serve her shadow mistress, only to find out through their bonding that things are not what they appear to be.",
        img: "https://images8.alphacoders.com/118/thumb-1920-1186126.jpg",
        hasVideoDownload: true, 
        videoDownloadLink: "https://motionpicturemafia.com/downloads"
      },
	{
        id: "Tonari_no_Seki-kun_The_Master_of_Killing_Time",
        title: "Tonari no Seki-kun: The Master of Killing Time",
        plot: "Rumi Yokoi is confused about the boy sitting next to her in class who never pays attention to his surrounding. When she learns about the truth, she gets drawn into his life.",
        img: "https://m.media-amazon.com/images/S/pv-target-images/56c65f24437800ba4e420000d93c0e7fd5c8b0c82833c2e2c58f27a7ac461b36.jpg",
        hasVideoDownload: true, 
        videoDownloadLink: "https://motionpicturemafia.com/downloads"
      },
	{
        ...
        plot: "After cursing the novel Proud Immortal Demon Way, Shen Yuan finds himself in the book as the scumbag villain Shen Qingqiu.",
        img: "https://vcover-hz-pic.wetvinfo.com/vcover_hz_pic/0/m2c25jodoyslvyv1730718395992_QJWE8tof/0",
        hasVideoDownload: true, 
        videoDownloadLink: "https://motionpicturemafia.com/downloads"
      },
	{
        id: "Chaos_Dragon",
        title: "Chaos Dragon",
        plot: "Chaos Dragon depicts two warring nations with island country Nil Kamui caught in between after guardian god Red Dragon goes berserk.",
        img: "https://imgsrv.crunchyroll.com/cdn-cgi/image/fit=contain,format=auto,quality=85,width=1200,height=675/catalog/crunchyroll/90e6e7bcc24e26e5f26969322bb03061.jpg",
        hasVideoDownload: true, 
        videoDownloadLink: "https://motionpicturemafia.com/downloads"
      },
    {
    ...
    },
    {
      ...
      {
        id: "More_Than_a_Married_Couple_But_Not_Lovers",
    ...
    // Add more series here, including 'hasVideoDownload: true' 
    // and 'videoDownloadLink' for the ones that need the button.
];
    ...
    container.innerHTML = list.map(sub => `
        <div class="card">
            ...
            <div class="card-content">
                ...
                ${sub.hasVideoDownload ? `<a class="btn general-download-btn" href="${sub.videoDownloadLink}" target="_blank">⬇️ Download Video Files</a>` : ''}
            </div>
        </div>
    `).join("");
}
